...
//oracle keywords
var oracleKeyWords = map[string]string{
	"access":     `"access"`,
	"add":        `"add"`,
	"all":        `"all"`,
	"alter":      `"alter"`,
...
func registerModel(driver, prefix string, model interface{}) {
...
// register models
func RegisterModel(driver string, models ...interface{}) {
	RegisterModelWithPrefix(driver, "", models...)
}

// register models with a prefix
func RegisterModelWithPrefix(driver, prefix string, models ...interface{}) {
	if modelCache.done {
		panic(fmt.Errorf("RegisterModel must be run before BootStrap"))
	}

	for _, model := range models {
		registerModel(driver, prefix, model)
	}
}
...
func suitForKeyWords(fi *fieldInfo) {
